...
public class DeDup {
	...
	public synchronized int[] getDeDupedIntegers(int [] array){
		return IntStream.of(array).boxed().collect(Collectors.toCollection(HashSet::new)).stream().mapToInt(i->i).toArray();
	}

	public synchronized int[] getDeDupedIntegersWithOrder(int [] array){
		return IntStream.of(array).boxed().collect(Collectors.toCollection(LinkedHashSet::new)).stream().mapToInt(i->i).toArray();		
	}
	
	public synchronized int[] getDeDupedIntegersSorted(int [] array){
